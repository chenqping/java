...
import input.InputStream.examples.BufferedInputFile;
import java.io.*;
...
public class Exercise14 {
    ...
    public static void main(String[] args) throws IOException {
        BufferedReader in = new BufferedReader(
                new StringReader(
                        BufferedInputFile.read("D:\\Workspace\\intellij-workspace\\java\\IO\\src\\input\\InputStream\\exercises\\Exercise14.java")));
        // Buffered writer:
